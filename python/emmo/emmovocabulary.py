...
This addition (emmovocabulary.py) includes:
...
class EmmoVocab:
    # FLB why is placemant of template here ok utside of function file style in
    # FLB graphs have to be inside the get_dot_graph function?
...
#FLB since asstring is used several times in the vocabularydunciton and 
# only once in graphs (and otherwise none in the rest of the anthology 
#I moved it here.
