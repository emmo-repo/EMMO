...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Materials          | [https://w3id.org/emmo/reference/materials](https://raw.githubusercontent.com/emmo-repo/EMMO/1.0.0-rc4/reference/materials.ttl)   |
| Math               | [https://w3id.org/emmo/reference/math](https://raw.githubusercontent.com/emmo-repo/EMMO/1.0.0-rc4/reference/math.ttl)             |
| Models             | [https://w3id.org/emmo/reference/models](https://raw.githubusercontent.com/emmo-repo/EMMO/1.0.0-rc4/reference/models.ttl)         |
| Properties         | [https://w3id.org/emmo/disciplines/properties](https://raw.githubusercontent.com/emmo-repo/EMMO/1.0.0-rc4/disciplines/properties.ttl) |
| Metrology          | [https://w3id.org/emmo/reference/metrology](https://raw.githubusercontent.com/emmo-repo/EMMO/1.0.0-rc4/reference/metrology.ttl)   |
| Isq                | [https://w3id.org/emmo/reference/isq](https://raw.githubusercontent.com/emmo-repo/EMMO/1.0.0-rc4/reference/isq.ttl)               |
| Siunits            | [https://w3id.org/emmo/domain/siunits](https://raw.githubusercontent.com/emmo-repo/EMMO/1.0.0-rc4/domain/siunits.ttl)                           |
| Chemistry          | [https://w3id.org/emmo/reference/chemistry](https://raw.githubusercontent.com/emmo-repo/EMMO/1.0.0-rc4/reference/chemistry.ttl)   |
...
From EMMO 1.0.0-rc4 it is recommended to use HermiT as reasoner (distributed by default with Protege).
